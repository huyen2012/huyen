...
if(isset($_POST["submit"])){
    ...
    if(isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) &&
        ...
        $sql = "insert into sanpham(ten_sp,gia_sp,bao_hanh, tinh_trang,trang_thai,chi_tiet_sp,id_dm,anh_sp,dac_biet) 
        values
        ('$ten_sp','$gia_sp','$bao_hanh', '$tinh_trang','$trang_thai','$chi_tiet_sp','$id_dm','$anh_sp','$dac_biet')";
