        ...
        <div class="container">
            <div class="row">
                <div id="logo" class="col-md-3 col-sm-12 col-xs-12">
                    <h1>
                        <a href="index.php"><img src="img/home/logo.png" style="width:120px;"></a>
                    </h1>
                </div>
                <!-- timkiem -->
                <?php
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
                        <h3>Hotline</h3>
                        <p>Phone Sale: (+84) 0817 995 688</p>
                        <p>Email: huyen2012@gmail.com</p>
                    </div>
                    <div id="contact" class="col-md-6 col-sm-12 col-xs-12">
                        <h3>Contact Us</h3>
                        <p>Address : Hoàng Văn Thái - Thanh Xuân - Hà Nội</p>
                    </div>
                    <div id="scroll">
